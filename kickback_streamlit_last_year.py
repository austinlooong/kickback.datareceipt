...
st.set_page_config(page_title="Kickback Receipt (Last Year)", page_icon="🧾")
st.title("🧾 Kickback: Your Last Year on YouTube")

st.write("Upload your Google Takeout ZIP — we’ll generate a data receipt based only on the past 12 months of your activity.")
...
Top Watched Titles:
  • {watch_summary['top_titles'][0]}
  • {watch_summary['top_titles'][1]}
  • {watch_summary['top_titles'][2]}
...
Top Search Terms:
  • {search_summary['top_searches'][0]}
  • {search_summary['top_searches'][1]}
  • {search_summary['top_searches'][2]}
