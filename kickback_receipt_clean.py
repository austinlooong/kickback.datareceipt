...
st.write("We’ll turn your YouTube activity into a clear, ad-value receipt. Just drop in your Takeout .zip.")
...
if zip_file:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if watch_path and search_path:
            ...
            st.markdown("<pre style='background:#fdfdfd;padding:1.5rem;border:1px dashed #bbb;font-family:monospace;font-size:15px;white-space:pre-wrap'>" + receipt + "</pre>", unsafe_allow_html=True)
        else:
